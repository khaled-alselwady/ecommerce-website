...
function renderPaymentSummaryHTML() {
  ...
  const html = `
    ...
    <div class="payment-summary-row">
      ...
      <div class="payment-summary-money js-total-shipping-price-cents">$${formatCurrency(totalShippingPriceCents)}</div>
    </div>
    ...
    <div class="payment-summary-row total-row">
      <div>Order total:</div>
      <div class="payment-summary-money js-order-total-price-cent">$${formatCurrency(orderTotalCents)}</div>
    </div>
